      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-12 md:pt-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            ...
            <p className="text-xl text-gray-600">"Sign-x-Change is a revolutionary platform dedicated to bridging communication gaps for the deaf community. Our mission is to empower individuals to learn and communicate through sign language effortlessly. From interactive lessons and live practice sessions to connecting with a vibrant community, Sign x Change is your gateway to embracing the beauty and inclusivity of sign language."</p>
          </div>

...
const WORDS = ['DOG']; 
//  'CAT', 'HELLO', 'CAR', 'DRIVE', 'SUN', 'WALK', 'TABLE', 'TRUCK', 'RACE', 'CHAIR', 'WORLD', 'SAW', 'BIRD', 'CUBE', 'WATER', 'MILK', 'DESK', 'KNIFE', 'FORK', 'LIGHT', 'LAMP', 'OIL', 'RUBY', 'SALT', 'DUCK', 'BLUE', 'RED', 'DEBUG', 'CODE', 'CAT', 'DOG', 'FROG', 'TOAD', 'STAR', 'EARTH', 'START', 'LATE', 'EARLY', 'SIGN', 'HEAD', 'FOOT', 'HAND', 'EAR', 'EYE'
